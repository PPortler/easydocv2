...
import { mdiFolderFile, mdiMailboxOutline, mdiCog, mdiViewDashboard, mdiNearMe, mdiInvoiceTextClockOutline, mdiListStatus, mdiMessageProcessingOutline } from '@mdi/js';
    ...
    return (
        <div className='text-white p-5 pt-8 w-64 flex flex-col justify-between  flex-shrink-0'>
            <div>
                ...
                <div className='mt-10'>
                    <Link href="/admin" className={`${status === "dashboard" ? "bg-[#5852a5] border-s-4 border-white" : ""} hover:border-white hover:bg-[#5852a5] border-s-4 border-[#5955B3] flex cursor-pointer gap-3 py-3 px-4 `}>
                        <Icon path={mdiViewDashboard} size={1} />
                        <p>แดชบอร์ด</p>
                    </Link>
                    <Link href="/admin/manageFile" className={`${status === "myfile" ? "bg-[#5852a5] border-s-4 border-white" : ""} hover:border-white hover:bg-[#5852a5] border-s-4 border-[#5955B3] flex cursor-pointer gap-3 py-3 px-4 `}>
