        ...
        <div className='flex justify-between'>
            ...
            <div className='flex gap-2'>
                ...
                >
                    ...
                    {isUser && (
                        <div className='shadow absolute right-0 mt-1'>
                            <button className='py-1 px-4 hover:bg-[#5955B3] hover:text-white w-full'>Profile</button>
                            <button onClick={() => signOut()} className='py-1 px-4 hover:bg-[#5955B3] hover:text-white w-full'>Logout</button>
                        </div>
                    )}
                </div>
            </div>
